...
| 유형 | 설명 |
|------|------|
| 레포지토리 이미지 | 관리자가 등록한 레포지토리에서 탐색하여 선택합니다. |
| 퍼블릭 이미지 | Docker Hub 등 퍼블릭 이미지 주소를 직접 입력합니다. |
...
컨테이너 생성 1단계에서 레포지토리를 선택하면 등록된 이미지 목록을 탐색할 수 있습니다.
 
1. 이미지 선택 화면에서 레포지토리를 선택합니다.
...
레포지토리에 등록되지 않은 퍼블릭 이미지는 주소를 직접 입력하여 사용할 수 있습니다.
